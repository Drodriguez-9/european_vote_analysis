...
def preprocess_data():
    ...
    pd.get_dummies(loan_default_df, columns=categorical_columns, drop_first=False)
    # drop reason to try if improves
    loan_default_df = loan_default_df.drop(columns="REASON")
