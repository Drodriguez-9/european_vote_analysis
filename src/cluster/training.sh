...
### -- set the job Name --
#BSUB -J 32_with_20ksamples_noREASON
...
# Run nn
python /zhome/58/f/181392/DTU/MBML/european_vote_analysis/src/models/nn_training.py --num-warmup 1000 --num-samples 20000 --num-chains 1 --num-hidden 32 --device gpu --path /zhome/58/f/181392/DTU/MBML/european_vote_analysis/reports/figures --samples_name samples_32_with_20ksamples_noREASON
